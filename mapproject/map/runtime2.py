...
def create_graph2(name,loc):
    try:
        ...
        df = pd.read_csv("static/RuntimeS/Runtime2/{}/Location{}/Data.csv".format(name,str(loc)))
        ...
        plt.savefig('static/RuntimeS/Runtime2/{}/Location{}/Data.jpeg'.format(name,str(loc)),bbox_inches='tight')
...
def create_csv4():
    #getting the url
    url = urlopen("http://125.19.52.219/wqi/dinkingB.php")
    ...
    for i in range(1,93):
        ...
        df1=pd.read_csv("static/RuntimeS/Runtime2/Dissolved Oxygen/Location{}/Data.csv".format(str(i)))
        ...
        if float(a[-1]["Dissolved Oxygen"]) != float(temp_dic2["Dissolved Oxygen"]): 
            ...
            df2.to_csv('static/RuntimeS/Runtime2/Dissolved Oxygen/Location{}/Data.csv'.format(str(i)), index=False)
        ...
        #read the previously generated csv file
        df3=pd.read_csv("static/RuntimeS/Runtime2/Bio Chemical Oxygen Demand/Location{}/Data.csv".format(str(i)))
        #converting the data into list of dictionary
        ...
        if float(b[-1]["Bio Chemical Oxygen Demand"]) != float(temp_dic3["Bio Chemical Oxygen Demand"]): 
            ...
            df4=pd.DataFrame(b)
            #genrating the updated csv file
            df4.to_csv('static/RuntimeS/Runtime2/Bio Chemical Oxygen Demand/Location{}/Data.csv'.format(str(i)), index=False)
        ...
        #read the previously generated csv file
        df5=pd.read_csv("static/RuntimeS/Runtime2/Total Coliform/Location{}/Data.csv".format(str(i)))
        #converting the data into list of dictionary
        ...
        if float(c[-1]["Total Coliform"]) != float(temp_dic4["Total Coliform"]): 
            ...
            df6=pd.DataFrame(c)
            #genrating the updated csv file
            df6.to_csv('static/RuntimeS/Runtime2/Total Coliform/Location{}/Data.csv'.format(str(i)), index=False)
        ...
        #read the previously generated csv file
        df7=pd.read_csv("static/RuntimeS/Runtime2/pH/Location{}/Data.csv".format(str(i)))
        #converting the data into list of dictionary
        ...
        if float(d[-1]["pH"]) != float(temp_dic5["pH"]): 
            ...
            df8=pd.DataFrame(d)
            #genrating the updated csv file
            df8.to_csv('static/RuntimeS/Runtime2/pH/Location{}/Data.csv'.format(str(i)), index=False)
            create_graph2("pH",i)
